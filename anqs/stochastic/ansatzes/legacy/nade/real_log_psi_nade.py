...
from nqs.stochastic.ansatzes.legacy.anqs_primitives.nade import RealLogPsiMLP


class RealLogPsiNADE(AbstractNADE):
    def __init__(self,
                 *args,
                 depth: int = 0,
                 width: int = None,
                 ...
                 **kwargs):
        super(RealLogPsiNADE, self).__init__(*args, **kwargs)
        self.depth = depth
        self.width = width
        ...
        self.log_psi_mlps = nn.ModuleList([RealLogPsiMLP(in_num=qubit_idx,
                                                         depth=self.depth,
                                                         width=self.width,
